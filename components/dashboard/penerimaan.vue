        ...
        .then((res) => {
          ...
          for (let index = 0; index < this.dataKomoditas.length; index++) {
            ...
            this.chartOption.xAxis.categories.push(
              element.nama_komoditas +
                " (" +
                element.status +
                ") - " +
                element.nama_gudang
            );
            this.dataColli.push(element.jml_colli);
            this.dataBruto.push(parseFloat(element.jml_bruto));
            this.dataNetto.push(parseFloat(element.jml_netto));
          }
