<template>
  <div>
    <TableListMenu
      ...
      :listRole="list_role"
      :listPosisi="list_posisi"
      :listMenuUser="list_menu_user"
      :loadingMenuUser="isLoadingMenuUser"
      @fetchData="loadAll"
      @addItem="addItem"
      @editItem="editItem"
      @deleteItem="deleteItem"
      @load-menu-user="loadMenuUser"
      @addMenuUser="closeFormMenuUser"
      @delete-menu-user="deleteMenuUser"
    >
    </TableListMenu>
    <DialogFormSimple
      :formInput="formInput"
                ...
                <v-flex xs12 sm8 md8>
                  ...
                  >
                    <template v-slot:selection="data">
                      ...
                      >
                        <v-avatar left>
                          <v-icon>{{ data.item.class_icon }}</v-icon>
                        </v-avatar>
                        {{ data.item.nama_menu }}
                      </v-chip>
                    </template>
                    ...
                    <template slot="item" slot-scope="data">
                      <template v-if="data.item !== 'object'">
                        ...
                        <v-list-item-content>
                          <v-list-item-title
                            v-text="data.item.nama_menu"
                          ></v-list-item-title>
                          <v-list-item-subtitle>
                            Link:
                            {{ data.item.link_menu ? data.item.link_menu : "" }} -
                            Ket:
                            {{
